const welcomeTexts = [
  { main: "Memory Website", sub: "A place to store our stories." },
  { main: "For Beautiful Memories", sub: "All special moments are stored here." },
  { main: "For Me and You", sub: "Thank you for being part of my life." }
];
...
const songs = {
  perfect: { url: "myAudio/Bimbaakash.mp3", title: "Bimbaakash - Bartika Eam Rai" },
  thousand: { url: "myAudio/BAARISHEIN.mp3", title: "Anuv Jain" },
  allofme: { url: "myAudio/Tribal Rain- Jiunu Nai Hola.mp3", title: "Tribal Rain" }
};
...
const startDate = new Date("2023-09-25T00:00:00").getTime();
